...
//==============================================================================
/// Reorders data arrays according to SortPart (for unsigned values).
//==============================================================================
void JCellDivGpu::SortDataArrays(const unsigned* a, unsigned* a2) {
    const unsigned pini = (DivideFull ? 0 : NpbFinal);
    cudiv::SortDataParticles(Nptot, pini, SortPart, a, a2);
}

//==============================================================================
/// Reorders data arrays according to SortPart (for tmatrix3d values).
//==============================================================================
void JCellDivGpu::SortDataArrays(const tmatrix3d* a, tmatrix3d* a2) {
    const unsigned pini = (DivideFull ? 0 : NpbFinal);
    cudiv::SortDataParticles(Nptot, pini, SortPart, a, a2);
}


void JCellDivGpu::SortDataArrays(const tmatrix3f* a, tmatrix3f* a2) {
    const unsigned pini = (DivideFull ? 0 : NpbFinal);
    cudiv::SortDataParticles(Nptot, pini, SortPart, a, a2);
}
//==============================================================================
/// Reorders data arrays according to SortPart (for float3 values).
//==============================================================================
//void JCellDivGpu::SortDataArrays(const float3* a, float3* a2) {
//    const unsigned pini = (DivideFull ? 0 : NpbFinal);
//    cudiv::SortDataParticles(Nptot, pini, SortPart, a, a2);
