...
protected:
  ...
  TpVolConserve TVolConserve; ///<Volume-conservation Mode 0:None 1:VCS>
  TpDivClean TDivClean;       ///<Velocity-divergence Error Clean Mode 0:None 1:VEM 2:VEM+HPDC>
  float VEMThreshold;         ///<VEM Acceleration Threshold>
  float Beta;                 ///<Coefficient for Rimeann dissipation limiter>
  TpOps TShiftingOPS;         ///<Particle shifting 0:None 1:OPS>
  ...
  //-Constant for reference density and reference number of neighbor 
  float RhobarRef; unsigned NRef;
