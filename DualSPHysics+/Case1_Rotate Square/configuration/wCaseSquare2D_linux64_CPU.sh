...
${measuretool} -dirin ${diroutdata} -points Case_PointsPressure_Correct.txt -onlytype:+all,+fluid -vars:-all,+press -kclimit:0.5 -savevtk ${dirout2}/pressure -savecsv ${dirout2}/_pressure 
if [ $? -ne 0 ] ; then fail; fi
