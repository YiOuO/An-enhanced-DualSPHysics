...
inline float TFloat3Norm(const tfloat3& a) { return(float(sqrt(a.x*a.x+a.y*a.y+a.z*a.z))); }
...
inline double TDouble3Norm(const tdouble3& a) { return(double(sqrt(a.x * a.x + a.y * a.y + a.z * a.z))); }
