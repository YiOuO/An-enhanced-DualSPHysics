...
, const unsigned* pardet, const float* veldiv,const float* rhoover
,const tfloat3* parnormal)const
{
  ...
  arrays.AddArray("NormalVec", np, parnormal);
  arrays.AddArray("VelDiv", np, veldiv);
  //arrays.AddArray("PressVcs", np, pressvcs);
